<template>
  <div>
    ...
    <ul>
      ...
      <li><strong>Baroque</strong>: Art, architecture, and music of the 17th and early 18th centuries</li>
      ...
      <li><strong>Gregorian Chant</strong>: A form of plainchant. Modal, monophonic melodies with unmeasured rhythm. Sacred, liturgical music of Roman Catholic Church that implements Latin texts</li>
...
export default {
  ...
  metaInfo: {
    ...
    link: [
      { rel: "canonical", href: "https://chingchang.netlify.com/music-history" }
    ]
  }
};
</script>

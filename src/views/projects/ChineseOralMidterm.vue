<template>
  <div id="presentation">
    <div class="row">
      ...
      <div class="circle big">
        <picture>
          ...
          <img src="@/assets/pictures/contact.jpg" alt="Ching Chang coding" />
        </picture>
        <div class="text">
          <div class="title">自由網站開發員</div>
        </div>
      </div>

      <div class="circle big second-career">
        <picture>
    ...
    <div class="row">
      ...
      <div class="circle">
        <picture>
          ...
          <img src="@/assets/about-me/other-sites-i-made.jpg" alt="Ching Chang rhino nerd" />
        </picture>
        <div class="text">
          <div class="title">天份||特長</div>
          <div>學東西很快</div>
          <div>記憶力好</div>
          <div>有創意</div>
          <div>獨立</div>
      ...
      <div class="circle">
        <picture>
          ...
          <img src="@/assets/about-me/ching-chang.jpg" alt="Ching Chang profession suit" />
        </picture>
        <div class="text">
      ...
      <div class="circle">
        <picture>
          ...
          <img src="@/assets/pictures/featured.jpg" alt="Ching Chang chiaroscuro reflecting" />
        </picture>
        <div class="text">
    ...
    <div class="row">
      <div class="big-text">為什麼我適合這份工作?</div>
    </div>
    ...
    <div class="row">
      <div class="circle second-career">
        <picture>
          ...
          <img src="@/assets/about-me/trivia.jpg" alt="Ching Chang flexing" />
        </picture>
        <div class="text">
          <div class="title">價值觀</div>
          <div>我不能永遠擁有快樂，但是我永遠可以讓別人快樂</div>
        </div>
      </div>
      ...
      <div class="circle second-career">
        <picture>
          ...
          <img src="@/assets/about-me/literature.jpg" alt="Ching Chang and his wings" />
        </picture>
        <div class="text">
          <div class="title">天份||特長</div>
          <div>記憶力好</div>
